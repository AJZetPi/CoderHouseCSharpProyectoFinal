    ...
    public class ADO_ProductoVendido
    {
        ...
        public static void ModificarProductosVendidos(ProductoVendido productovendido)
        {
            using (SqlConnection connection = new SqlConnection(General.connectionString()))
            {
                ...
                cmd3.CommandText = "UPDATE venta SET Stock=@stock,IdProducto=@idproducto,IdVenta=@idventa WHERE id=@id";
        ...
        public static void AgregarProductosVendidos(ProductoVendido productovendido)
        {
            ...
            using (SqlConnection connection = new SqlConnection(General.connectionString()))
            {
                ...
                cmd4.CommandText = "INSERT INTO producto (Stock,IdProducto,IdVenta)" + "values(@stock,@idproducto,idventa)";
