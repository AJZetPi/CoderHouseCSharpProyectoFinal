    ...
    public class ADO_Producto
    {
        ...
        public static void ModificarProductos(Producto producto)
        {
            using (SqlConnection connection = new SqlConnection(General.connectionString()))
            {
                ...
                cmd3.CommandText = "UPDATE producto SET Descripciones=@descripciones, Costo=@costo,PrecioVenta=@precioventa,Stock=@stock,IdUsuario=@idusuario WHERE id=@id";
        ...
        public static void AgregarProductos(Producto producto)
        {
            ...
            using (SqlConnection connection = new SqlConnection(General.connectionString()))
            {
                ...
                cmd4.CommandText = "INSERT INTO producto ( Descripciones, Costo,PrecioVenta,Stock,IdUsuario)" + "values(@descripciones,@costo,@precioventa,@stock,@idusuario)";
