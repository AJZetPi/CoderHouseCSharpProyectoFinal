    ...
    public class ADO_Venta
    {
        ...
        public static void ModificarVentas(Venta venta)
        {
            using (SqlConnection connection = new SqlConnection(General.connectionString()))
            {
                ...
                cmd3.CommandText = "UPDATE venta SET Comentarios=@comentarios,IdUsuario=@idusuario WHERE id=@id";
        ...
        public static void AgregarVentas(Venta venta)
        {
            ...
            using (SqlConnection connection = new SqlConnection(General.connectionString()))
            {
                ...
                cmd4.CommandText = "INSERT INTO producto (Comentarios,IdUsuario)" + "values(@comentarios,@idusuario)";
