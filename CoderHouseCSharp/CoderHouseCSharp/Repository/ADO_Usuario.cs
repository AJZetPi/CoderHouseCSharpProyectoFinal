...
namespace CoderHouse_CSharp_API.Repository
{
    public class ADO_Usuario
    {
        ...
        public static List<Usuario> DevolverLogin(string NombreUsuario, string Contraseña)
        {
            var listaUsuarios = new List<Usuario>();
            using (SqlConnection connection = new SqlConnection(General.connectionString()))
            {
                ...
                cmd6.CommandText = "SELECT * FROM Usuario WHERE NombreUsuario = @NombreUsuario AND Contraseña = @Contraseña";
                ...
                var parametroContraseña = new SqlParameter();
                ...
                cmd6.Parameters.Add(parametroContraseña);
        ...
        public static void ModificarUsuarios(Usuario usuario)
        {
            using (SqlConnection connection = new SqlConnection(General.connectionString()))
            {
                ...
                cmd3.CommandText = "UPDATE usuario SET Id=@id, Nombre=@nombre, Apellido=@apellido,NombreUsuario=@nombreusuario,Contraseña=@contraseña,Mail=@mail";
        ...
        public static void AgregarUsuarios(Usuario usuario)
        {
            ...
            using (SqlConnection connection = new SqlConnection(General.connectionString()))
            {
                ...
                cmd4.CommandText = "INSERT INTO usuario ( Nombre, Apellido,NombreUsuario,Contraseña,Mail)" + "values(@nombre,@apellido,@nombreusuario,@contraseña,@mail)";
